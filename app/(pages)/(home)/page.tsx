            ...
            <header>
                <div className="text-container">
                    <div className="header-headline">
                        <h1 className="title">Let's start coding and make your idea a reality</h1>
                        <p className="description">Group of developers ready to collaborate in your business idea.</p>
                    </div>
                    <div className="buttons">
                        <a href="#" className="link">Contact Us</a>
                        <a href="#" className="link-outline">Our Services</a>
                    </div>
                </div>
            </header>
                    ...
                    <div className="projects-preview">
                        {
                            projectList.map((project) => (
                                <Card image={project.image} title={project.title} date={project.date} description={project.description} />
                            ))
                        }
                    </div>
                </div>
